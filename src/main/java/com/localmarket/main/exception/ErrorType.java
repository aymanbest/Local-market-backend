...
public enum ErrorType {
    ...
    REVIEW_ACCESS_DENIED(HttpStatus.UNAUTHORIZED),
    REVIEW_INVALID_STATE(HttpStatus.BAD_REQUEST),
    REVIEW_CANCELLATION_FAILED(HttpStatus.BAD_REQUEST),
    REVIEW_ELIGIBILITY(HttpStatus.BAD_REQUEST),
    ...
    EMAIL_SENDING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR);
